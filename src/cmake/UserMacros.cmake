...
MACRO(CREA_ADD_LIBRARY LIBRARY_NAME)
  ...
  # CREATE THE TARGET
  SET(${LIBRARY_NAME}_SOURCES_ALL ${${LIBRARY_NAME}_SOURCES} ${${LIBRARY_NAME}_HEADERS})
  ADD_LIBRARY(${LIBRARY_NAME} ${${LIBRARY_NAME}_SHARED} ${${LIBRARY_NAME}_SOURCES_ALL})
...
MACRO(CREA_ADD_CUSTOM_TARGET TARGET_NAME)
  ...
  add_custom_target(${LIBRARY_NAME} SOURCES ${${TARGET_NAME}_SOURCES_ALL})
